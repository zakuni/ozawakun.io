  ...
  <>
    <footer className="uk-text-center uk-link-muted uk-text-meta">
      <div className="uk-margin-small-bottom">
        ...
        <a href="https://github.com/zakuni" target="_blank" rel="noopener" className="uk-icon-button uk-margin-small-right" uk-icon="github" />
        <a href="https://www.instagram.com/zakuni/" target="_blank" rel="noopener" className="uk-icon-button uk-margin-small-right" uk-icon="instagram" />
        <a href="https://www.linkedin.com/in/kunioozawa/" target="_blank" rel="noopener" className="uk-icon-button" uk-icon="linkedin" />
      </div>
      <div>
