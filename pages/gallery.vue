<template>
    <div class="uk-container uk-container-small uk-width-3-4@s uk-margin-remove-top">
      <main>
        <section class="uk-section" id="gallery">
          ...
          <h4 class="uk-margin-xlarge-top">Something</h4>
          ...
          <div class="uk-flex-middle" uk-grid="">
            <div class="uk-width-1-4@s uk-text-center">
            <a href="https://editor.p5js.org/full/r1kK6YVqf"><img alt="sketch particle" class="uk-box-shadow-medium uk-box-shadow-hover-large" src="/images/sketch_particle.png" width="200px" /></a>
            </div>
            <div class="uk-width-3-4@s">
              <p>
          ...
          <div class="uk-flex-middle" uk-grid="">
            <div class="uk-width-1-4@s uk-text-center">
              <a class="uk-link-reset" href="http://machiawase.herokuapp.com">
                <div class="uk-box-shadow-medium uk-box-shadow-hover-large uk-padding">
                  街合わせ
                </div>
              </a>
            </div>
          ...
          <div class="uk-flex-middle" uk-grid="">
            <div class="uk-width-1-4@s uk-text-center">
              <a class="uk-link-reset" href="http://boy2man.herokuapp.com">
                <div class="uk-box-shadow-medium uk-box-shadow-hover-large uk-padding">
                  Boy2Man
                </div>
              </a>
          ...
          <div class="uk-flex-middle" uk-grid="">
            <div class="uk-width-1-4@s uk-text-center">
              <a class="uk-link-reset" href="/smoothsnap/sample.html">
                <div class="uk-box-shadow-medium uk-box-shadow-hover-large uk-padding">
                  SmoothSnap
                </div>
              </a>
          ...
          <div class="uk-flex-middle" uk-grid="">
            <div class="uk-width-1-4@s">
              <a href="/sakurafubuki/index.html"><img alt="sakurafubuki" class="uk-box-shadow-medium uk-box-shadow-hover-large" src="/images/sakurafubuki.png" width="200px" /></a>
            </div>
            <div class="uk-width-3-4@s">
              <h5>
                桜吹雪
          ...
          <div class="uk-flex-middle" uk-grid="">
            <div class="uk-width-1-4@s">
              <a href="/chirimomiji/index.html"><img alt="chirimomiji" class="uk-box-shadow-medium uk-box-shadow-hover-large" src="/images/chirimomiji.png" width="200px" /></a>
            </div>
            <div class="uk-width-3-4@s">
              <h5>
                散り紅葉
